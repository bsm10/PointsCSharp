    ...
    public partial class GameDots : IEnumerator, IEnumerable
    {
        private List<Dot> CheckPattern(int Owner)
        {
            ...
            var pat3 = from Dot d in get_non_blocked
                       where d.Own == Owner && d.x > 2 && d.x < BoardWidth - 2 &&
                                                d.y > 2 && d.y < BoardHeight - 2 && 
            ...
            var pat3_1_1 = from Dot d in get_non_blocked
                           ...
                           this[d.x, d.y + 1].Own == 0 && this[d.x, d.y + 1].Blocked == false &&
                           this[d.x - 1, d.y + 1].Own == 0 && this[d.x - 1, d.y + 1].Blocked == false &&
                           this[d.x, d.y].Own == Owner && this[d.x, d.y].Blocked == false
                           select d;
            if (pat3_1_1.Count() > 0)
            {
            ...
            var pat5_1 = from Dot d in get_non_blocked
                         where d.Own == Owner && this[d.x + 2, d.y].Own == Owner && this[d.x + 2, d.y].Blocked == false &&
                                                this[d.x + 1, d.y].Own == enemy_own && this[d.x + 1, d.y].Blocked == false &&
                                                this[d.x - 1, d.y - 1].Own == enemy_own && this[d.x - 1, d.y - 1].Blocked == false &&
                                                this[d.x, d.y - 1].Own == 0 && this[d.x, d.y - 1].Blocked == false &&
                                                this[d.x + 1, d.y - 1].Own == enemy_own && this[d.x + 1, d.y - 1].Blocked == false &&
...
&& this[d.x - 1, d.y - 1].Own == 0 && this[d.x - 1, d.y - 1].Blocked == false
            ...
            //============================================================================================================== 
            iNumberPattern = 222;
            var pat222 = from Dot d in this
                         where d.Own == Owner
                             && this[d.x, d.y - 4].Own == Owner && this[d.x, d.y - 4].Blocked == false
                             ...
                             && this[d.x - 1, d.y - 2].Own == 0 && this[d.x - 1, d.y - 2].Blocked == false
                             && this[d.x - 1, d.y - 3].Own == 0 && this[d.x - 1, d.y - 3].Blocked == false
                             && this[d.x - 1, d.y - 4].Own == 0 && this[d.x - 1, d.y - 4].Blocked == false
                             && this[d.x - 1, d.y].Own == 0 && this[d.x - 1, d.y].Blocked == false
            ...
            var pat222_2_3 = from Dot d in this
                             where d.Own == Owner
                                 && this[d.x + 4, d.y].Own == Owner && this[d.x + 4, d.y].Blocked == false
                                 ...
                                 && this[d.x + 2, d.y + 1].Own == 0 && this[d.x + 2, d.y + 1].Blocked == false
                                 && this[d.x + 3, d.y + 1].Own == 0 && this[d.x + 3, d.y + 1].Blocked == false
                                 && this[d.x + 4, d.y + 1].Own == 0 && this[d.x + 4, d.y + 1].Blocked == false
                                 && this[d.x, d.y + 1].Own == 0 && this[d.x, d.y + 1].Blocked == false
                                 && this[d.x + 1, d.y - 1].Own == Owner && this[d.x + 1, d.y - 1].Blocked == false
                             select d;
            ...
            //============================================================================================================== 
            iNumberPattern = 935;
            var pat935 = from Dot d in this
                         where d.Own == Owner
                             && this[d.x - 3, d.y - 3].Own == Owner && this[d.x - 3, d.y - 3].Blocked == false
                             && this[d.x - 1, d.y - 2].Own == enemy_own && this[d.x - 1, d.y - 2].Blocked == false
                             && this[d.x - 1, d.y - 1].Own == 0 && this[d.x - 1, d.y - 1].Blocked == false
                             && this[d.x - 1, d.y].Own == 0 && this[d.x - 1, d.y].Blocked == false
                             && this[d.x - 2, d.y].Own == 0 && this[d.x - 2, d.y].Blocked == false
            ...
            //============================================================================================================== 
            iNumberPattern = 598;
            var pat598 = from Dot d in this
                         where d.Own == Owner
                             && this[d.x + 5, d.y - 3].Own == Owner && this[d.x + 5, d.y - 3].Blocked == false
                             && this[d.x + 1, d.y].Own == 0 && this[d.x + 1, d.y].Blocked == false
                             && this[d.x + 1, d.y - 1].Own == 0 && this[d.x + 1, d.y - 1].Blocked == false
                             && this[d.x + 2, d.y].Own == 0 && this[d.x + 2, d.y].Blocked == false
                             && this[d.x + 2, d.y - 1].Own == 0 && this[d.x + 2, d.y - 1].Blocked == false
                             ...
                             && this[d.x + 3, d.y - 2].Own == 0 && this[d.x + 3, d.y - 2].Blocked == false
                             && this[d.x + 4, d.y - 1].Own == 0 && this[d.x + 4, d.y - 1].Blocked == false
                             && this[d.x + 4, d.y - 2].Own == 0 && this[d.x + 4, d.y - 2].Blocked == false
                             && this[d.x + 4, d.y - 3].Own == 0 && this[d.x + 4, d.y - 3].Blocked == false
                             && this[d.x + 5, d.y - 2].Own == 0 && this[d.x + 5, d.y - 2].Blocked == false
                             && this[d.x + 3, d.y].Own == 0 && this[d.x + 3, d.y].Blocked == false
                             && this[d.x + 4, d.y].Own == 0 && this[d.x + 4, d.y].Blocked == false
                             && this[d.x + 5, d.y - 1].Own == 0 && this[d.x + 5, d.y - 1].Blocked == false
                         select d;
            if (pat598.Count() > 0)
            {
            ...
            var pat598_2_3 = from Dot d in this
                             where d.Own == Owner
                                 && this[d.x + 3, d.y - 5].Own == Owner && this[d.x + 3, d.y - 5].Blocked == false
                                 && this[d.x, d.y - 1].Own == 0 && this[d.x, d.y - 1].Blocked == false
                                 && this[d.x + 1, d.y - 1].Own == 0 && this[d.x + 1, d.y - 1].Blocked == false
                                 && this[d.x, d.y - 2].Own == 0 && this[d.x, d.y - 2].Blocked == false
                                 && this[d.x + 1, d.y - 2].Own == 0 && this[d.x + 1, d.y - 2].Blocked == false
                                 ...
                                 && this[d.x + 2, d.y - 3].Own == 0 && this[d.x + 2, d.y - 3].Blocked == false
                                 && this[d.x + 1, d.y - 4].Own == 0 && this[d.x + 1, d.y - 4].Blocked == false
                                 && this[d.x + 2, d.y - 4].Own == 0 && this[d.x + 2, d.y - 4].Blocked == false
                                 && this[d.x + 3, d.y - 4].Own == 0 && this[d.x + 3, d.y - 4].Blocked == false
                                 && this[d.x + 2, d.y - 5].Own == 0 && this[d.x + 2, d.y - 5].Blocked == false
                                 && this[d.x, d.y - 3].Own == 0 && this[d.x, d.y - 3].Blocked == false
                                 && this[d.x, d.y - 4].Own == 0 && this[d.x, d.y - 4].Blocked == false
                                 && this[d.x + 1, d.y - 5].Own == 0 && this[d.x + 1, d.y - 5].Blocked == false
                             select d;
...
&& this[d.x, d.y + 2].Own == 0
            ...
            var pat472 = from Dot d in get_non_blocked
                         where d.Own == Owner
                             ...
                             && this[d.x + 1, d.y + 2].Own == 0
                             && this[d.x, d.y + 2].Own == 0
                             && this[d.x, d.y + 3].Own == enemy_own
                             && this[d.x + 1, d.y + 3].Own == 0
                             && this[d.x + 2, d.y + 1].Own == 0
                             && this[d.x + 2, d.y + 2].Own == 0
                         select d;
            if (pat472.Count() > 0)
            ...
            var pat472_2_3 = from Dot d in get_non_blocked
                             where d.Own == Owner
                                 ...
                                 && this[d.x - 2, d.y - 1].Own == 0
                                 && this[d.x - 2, d.y].Own == 0
                                 && this[d.x - 3, d.y].Own == enemy_own
                                 && this[d.x - 3, d.y - 1].Own == 0
                                 && this[d.x - 1, d.y - 2].Own == 0
                                 && this[d.x - 2, d.y - 2].Own == 0
                             select d;
...
&& this[d.x, d.y + 1].Own == 0 && this[d.x, d.y + 1].Blocked == false
            ...
            var pat879_2_3 = from Dot d in get_non_blocked
                             where d.Own == Owner && d.x + 4 < BoardWidth && d.x - 4 > 0 && d.y + 4 < BoardHeight && d.y - 4 > 0
&& this[d.x + 3, d.y + 3].Own == Owner && this[d.x + 3, d.y + 3].Blocked == false
...
&& this[d.x - 1, d.y + 4].Own == Owner
&& this[d.x, d.y + 1].Own == 0
&& this[d.x, d.y + 2].Own == 0
&& this[d.x, d.y + 3].Own == 0
&& this[d.x + 1, d.y + 1].Own == 0
&& this[d.x + 1, d.y + 2].Own == 0
&& this[d.x + 1, d.y + 3].Own == 0
                         select d;
...
&& this[d.x - 4, d.y + 1].Own == Owner
&& this[d.x - 1, d.y].Own == 0
&& this[d.x - 2, d.y].Own == 0
&& this[d.x - 3, d.y].Own == 0
&& this[d.x - 1, d.y - 1].Own == 0
&& this[d.x - 2, d.y - 1].Own == 0
&& this[d.x - 3, d.y - 1].Own == 0
                             select d;
...
&& this[d.x - 1, d.y].Own != enemy_own
            ...
            var pat517 = from Dot d in get_non_blocked
                         where d.Own == Owner && (d.x - 1) > 0 && (d.y + 2) < BoardHeight && (d.x + 2) < BoardWidth && (d.y - 1) > 0
&& this[d.x, d.y - 1].Own == Owner && this[d.x, d.y - 1].Blocked == false
&& this[d.x + 1, d.y - 1].Own == enemy_own && this[d.x + 1, d.y - 1].Blocked == false
&& this[d.x + 1, d.y].Own == 0 && this[d.x + 1, d.y].Blocked == false
&& this[d.x + 1, d.y + 1].Own == 0 && this[d.x + 1, d.y + 1].Blocked == false
...
&& this[d.x + 2, d.y].Own == enemy_own && this[d.x + 2, d.y].Blocked == false
            ...
            var pat726 = from Dot d in get_non_blocked
                         where d.Own == Owner && d.x > 1 && d.y > 1 && d.x < BoardWidth - 1 && d.y < BoardHeight - 1
                             && this[d.x - 1, d.y].Own == Owner && this[d.x - 1, d.y].Blocked == false
                             && this[d.x - 2, d.y - 1].Own == enemy_own && this[d.x - 2, d.y - 1].Blocked == false
                             && this[d.x - 1, d.y - 1].Own == 0 && this[d.x - 1, d.y - 1].Blocked == false
                             && this[d.x + 1, d.y - 1].Own == 0 && this[d.x + 1, d.y - 1].Blocked == false
            ...
            var pat15 = from Dot d in get_non_blocked
                        where d.Own == Owner && d.x + 2 == BoardWidth
                            && this[d.x + 1, d.y + 1].Own == enemy_own && this[d.x + 1, d.y + 1].Blocked == false
                            && this[d.x, d.y + 1].Own == enemy_own && this[d.x, d.y + 1].Blocked == false
                            && this[d.x + 1, d.y].Own == 0 && this[d.x + 1, d.y].Blocked == false
                        select d;
            ...
            var pat15_2_3_4 = from Dot d in get_non_blocked
                              where d.Own == Owner && d.y + 2 == BoardHeight
                                  && this[d.x + 1, d.y + 1].Own == enemy_own && this[d.x + 1, d.y + 1].Blocked == false
                                  && this[d.x + 1, d.y].Own == enemy_own && this[d.x + 1, d.y].Blocked == false
                                  && this[d.x, d.y + 1].Own == 0 && this[d.x, d.y + 1].Blocked == false
                              select d;
...
&& this[d.x + 1, d.y - 1].Own == Owner && this[d.x + 1, d.y - 1].Blocked == false
            ...
            var pat4_1 = from Dot d in get_non_blocked
                         where d.Own == Owner && this[d.x - 1, d.y].Own == Owner && this[d.x - 1, d.y].Blocked == false &&
                                                this[d.x - 1, d.y + 1].Own == enemy_own && this[d.x - 1, d.y + 1].Blocked == false &&
                                                this[d.x + 1, d.y + 1].Own == enemy_own && this[d.x + 1, d.y + 1].Blocked == false &&
                                                this[d.x, d.y + 1].Own == 0 && this[d.x, d.y + 1].Blocked == false &&
                                                this[d.x, d.y + 2].Own == 0 && this[d.x, d.y + 2].Blocked == false &&
            ...
            var pat4_2 = from Dot d in get_non_blocked
                         where d.Own == Owner && this[d.x - 1, d.y].Own == 0 && this[d.x - 1, d.y].Blocked == false &&
                                                this[d.x - 1, d.y + 1].Own == enemy_own && this[d.x - 1, d.y + 1].Blocked == false &&
                                                this[d.x + 1, d.y + 1].Own == enemy_own && this[d.x + 1, d.y + 1].Blocked == false &&
                                                this[d.x, d.y + 1].Own == 0 && this[d.x, d.y + 1].Blocked == false &&
                                                this[d.x, d.y + 2].Own == 0 && this[d.x, d.y + 2].Blocked == false &&
            ...
            var pat4_3 = from Dot d in get_non_blocked
                         where d.Own == Owner && this[d.x - 1, d.y].Own == Owner && this[d.x - 1, d.y].Blocked == false &&
                                                ...
                                                this[d.x + 1, d.y - 1].Own == enemy_own && this[d.x + 1, d.y - 1].Blocked == false &&
                                                this[d.x, d.y - 1].Own == 0 && this[d.x, d.y - 1].Blocked == false &&
                                                this[d.x, d.y - 2].Own == 0 && this[d.x, d.y - 1].Blocked == false &&
                                                this[d.x + 1, d.y].Own == 0 && this[d.x + 1, d.y].Blocked == false
                         select d;
            if (pat4_3.Count() > 0)
            {
            ...
            var pat4_5 = from Dot d in get_non_blocked
                         where d.Own == Owner && this[d.x, d.y - 1].Own == Owner && this[d.x, d.y - 1].Blocked == false &&
                                                this[d.x - 1, d.y].Own == enemy_own && this[d.x - 1, d.y].Blocked == false &&
                                                this[d.x - 1, d.y - 1].Own == 0 && this[d.x - 1, d.y - 1].Blocked == false &&
                                                this[d.x - 1, d.y - 2].Own == enemy_own && this[d.x - 1, d.y - 2].Blocked == false &&
                                                this[d.x, d.y - 2].Own == 0 && this[d.x, d.y - 2].Blocked == false &&
            ...
            //============================================================================================================== 
            iNumberPattern = 688;
            var pat688 = from Dot d in this
                         where d.Own == Owner
                             && this[d.x + 1, d.y].Own == enemy_own && this[d.x + 1, d.y].Blocked == false
                             && this[d.x + 2, d.y].Own == enemy_own && this[d.x + 2, d.y].Blocked == false
                             && this[d.x + 3, d.y].Own == enemy_own && this[d.x + 3, d.y].Blocked == false
                             && this[d.x + 4, d.y].Own == Owner && this[d.x + 4, d.y].Blocked == false
                             && this[d.x + 4, d.y + 1].Own == Owner && this[d.x + 4, d.y + 1].Blocked == false
                             && this[d.x + 3, d.y + 1].Own == 0 && this[d.x + 3, d.y + 1].Blocked == false
                             && this[d.x + 2, d.y + 1].Own == 0 && this[d.x + 2, d.y + 1].Blocked == false
                             && this[d.x + 1, d.y + 1].Own == 0 && this[d.x + 1, d.y + 1].Blocked == false
                             && this[d.x, d.y + 1].Own == 0 && this[d.x, d.y + 1].Blocked == false
            ...
            var pat688_2_3 = from Dot d in this
                             where d.Own == Owner
                                 ...
                                 && this[d.x, d.y - 3].Own == enemy_own && this[d.x, d.y - 3].Blocked == false
                                 && this[d.x, d.y - 4].Own == Owner && this[d.x, d.y - 4].Blocked == false
                                 && this[d.x - 1, d.y - 4].Own == Owner && this[d.x - 1, d.y - 4].Blocked == false
                                 && this[d.x - 1, d.y - 3].Own == 0 && this[d.x - 1, d.y - 3].Blocked == false
                                 && this[d.x - 1, d.y - 2].Own == 0 && this[d.x - 1, d.y - 2].Blocked == false
                                 && this[d.x - 1, d.y - 1].Own == 0 && this[d.x - 1, d.y - 1].Blocked == false
                                 && this[d.x - 1, d.y].Own == 0 && this[d.x - 1, d.y].Blocked == false
            ...
            var pat80_2 = from Dot d in this
                          where d.Own == enemy_own
                              && this[d.x - 3, d.y + 3].Own == enemy_own && this[d.x - 3, d.y + 3].Blocked == false
                              && this[d.x - 1, d.y + 1].Own == 0 && this[d.x - 1, d.y + 1].Blocked == false
                              && this[d.x - 2, d.y + 2].Own == 0 && this[d.x - 2, d.y + 2].Blocked == false
                              && this[d.x, d.y + 1].Own == 0 && this[d.x, d.y + 1].Blocked == false
                              && this[d.x, d.y + 2].Own == 0 && this[d.x, d.y + 2].Blocked == false
            ...
            //============================================================================================================== 
            iNumberPattern = 1224;
            var pat1224 = from Dot d in this
                          where d.Own == Owner
                              && this[d.x + 2, d.y + 3].Own == Owner && this[d.x + 2, d.y + 3].Blocked == false
                              && this[d.x + 1, d.y + 1].Own == 0 && this[d.x + 1, d.y + 1].Blocked == false
                              && this[d.x + 2, d.y + 2].Own == 0 && this[d.x + 2, d.y + 2].Blocked == false
            ...
            //============================================================================================================== 
            iNumberPattern = 330;
            var pat330 = from Dot d in this
                         where d.Own == Owner
                             && this[d.x + 2, d.y - 5].Own == Owner && this[d.x + 2, d.y - 5].Blocked == false
                             && this[d.x + 1, d.y - 5].Own == 0 && this[d.x + 1, d.y - 5].Blocked == false
                             && this[d.x + 1, d.y - 4].Own == 0 && this[d.x + 1, d.y - 4].Blocked == false
                             && this[d.x, d.y - 4].Own == 0 && this[d.x, d.y - 4].Blocked == false
                             && this[d.x, d.y - 3].Own == 0 && this[d.x, d.y - 3].Blocked == false
                             ...
                             && this[d.x - 1, d.y - 2].Own == 0 && this[d.x - 1, d.y - 2].Blocked == false
                             && this[d.x - 1, d.y - 1].Own == 0 && this[d.x - 1, d.y - 1].Blocked == false
                             && this[d.x, d.y - 5].Own == 0 && this[d.x, d.y - 5].Blocked == false
                             && this[d.x - 1, d.y - 4].Own == 0 && this[d.x - 1, d.y - 4].Blocked == false
                             && this[d.x + 1, d.y - 6].Own == 0 && this[d.x + 1, d.y - 6].Blocked == false
                             && this[d.x - 1, d.y].Own == 0 && this[d.x - 1, d.y].Blocked == false
                         select d;
            if (pat330.Count() > 0)
            {
            ...
            var pat330_2_3 = from Dot d in this
                             where d.Own == Owner
                                 && this[d.x + 5, d.y - 2].Own == Owner && this[d.x + 5, d.y - 2].Blocked == false
                                 && this[d.x + 5, d.y - 1].Own == 0 && this[d.x + 5, d.y - 1].Blocked == false
                                 && this[d.x + 4, d.y - 1].Own == 0 && this[d.x + 4, d.y - 1].Blocked == false
                                 && this[d.x + 4, d.y].Own == 0 && this[d.x + 4, d.y].Blocked == false
                                 && this[d.x + 3, d.y].Own == 0 && this[d.x + 3, d.y].Blocked == false
                                 ...
                                 && this[d.x + 2, d.y + 1].Own == 0 && this[d.x + 2, d.y + 1].Blocked == false
                                 && this[d.x + 1, d.y + 1].Own == 0 && this[d.x + 1, d.y + 1].Blocked == false
                                 && this[d.x + 5, d.y].Own == 0 && this[d.x + 5, d.y].Blocked == false
                                 && this[d.x + 4, d.y + 1].Own == 0 && this[d.x + 4, d.y + 1].Blocked == false
                                 && this[d.x + 6, d.y - 1].Own == 0 && this[d.x + 6, d.y - 1].Blocked == false
                                 && this[d.x, d.y + 1].Own == 0 && this[d.x, d.y + 1].Blocked == false
                             select d;
            ...
            //============================================================================================================== 
            iNumberPattern = 331;
            var pat331 = from Dot d in this
                         where d.Own == Owner
                             && this[d.x - 2, d.y - 1].Own == enemy_own && this[d.x - 2, d.y - 1].Blocked == false
                             && this[d.x + 2, d.y + 1].Own == enemy_own && this[d.x + 2, d.y + 1].Blocked == false
                             && this[d.x - 2, d.y - 1].IndexRelation == this[d.x + 2, d.y + 1].IndexRelation
                             && this[d.x - 1, d.y - 1].Own == 0 && this[d.x - 1, d.y - 1].Blocked == false
                             && this[d.x, d.y - 1].Own == 0 && this[d.x, d.y - 1].Blocked == false
                             && this[d.x + 1, d.y - 1].Own == 0 && this[d.x + 1, d.y - 1].Blocked == false
                             && this[d.x + 2, d.y - 1].Own == 0 && this[d.x + 2, d.y - 1].Blocked == false
            ...
            var pat331_2_3 = from Dot d in this
                             where d.Own == Owner
                                 && this[d.x + 1, d.y + 2].Own == enemy_own && this[d.x + 1, d.y + 2].Blocked == false
                                 && this[d.x - 1, d.y - 2].Own == enemy_own && this[d.x - 1, d.y - 2].Blocked == false
                                 && this[d.x + 1, d.y + 2].IndexRelation == this[d.x - 1, d.y - 2].IndexRelation
                                 && this[d.x + 1, d.y + 1].Own == 0 && this[d.x + 1, d.y + 1].Blocked == false
                                 && this[d.x + 1, d.y].Own == 0 && this[d.x + 1, d.y].Blocked == false
                                 && this[d.x + 1, d.y - 1].Own == 0 && this[d.x + 1, d.y - 1].Blocked == false
                                 && this[d.x + 1, d.y - 2].Own == 0 && this[d.x + 1, d.y - 2].Blocked == false
...
iNumberPattern = 831; 
var pat831 = from Dot d in this where d.Own == Owner 
 && this[d.x+4, d.y-2].Own == Owner && this[d.x+4, d.y-2].Blocked == false 
 && this[d.x+1, d.y].Own  == 0 && this[d.x+1, d.y].Blocked == false 
 && this[d.x+2, d.y].Own  == 0 && this[d.x+2, d.y].Blocked == false 
 && this[d.x+3, d.y].Own  == 0 && this[d.x+3, d.y].Blocked == false 
 && this[d.x+4, d.y].Own  == 0 && this[d.x+4, d.y].Blocked == false 
 ...
 && this[d.x+5, d.y].Own  == 0 && this[d.x+5, d.y].Blocked == false 
select d; 
 if (pat831.Count() > 0) ld.Add(new Dot(pat831.First().x+3,pat831.First().y));

//180 Rotate=========================================================================================================== 
var pat831_2 = from Dot d in this where d.Own == Owner 
 && this[d.x-4, d.y+2].Own == Owner && this[d.x-4, d.y+2].Blocked == false 
 && this[d.x-1, d.y].Own  == 0 && this[d.x-1, d.y].Blocked == false 
 && this[d.x-2, d.y].Own  == 0 && this[d.x-2, d.y].Blocked == false 
 && this[d.x-3, d.y].Own  == 0 && this[d.x-3, d.y].Blocked == false 
...
//============================================================================================================== 
 ...
 //180 Rotate=========================================================================================================== 
 var pat271_2 = from Dot d in this
               where d.Own == Owner
                   && this[d.x - 1, d.y - 2].Own == enemy_own && this[d.x - 1, d.y - 2].Blocked == false
                   && this[d.x - 1, d.y - 1].Own == Owner && this[d.x - 1, d.y - 1].Blocked == false
                   && this[d.x, d.y - 1].Own == enemy_own && this[d.x, d.y - 1].Blocked == false
